 var chartElement = document.createElement('div');
         ...
         chart.subscribeCrosshairMove((param) => {
             if (param.time) {
                 ...
                 firstRow.innerHTML = '<div style="font-size: 24px; margin: 4px 0px; color: #fff"> Total Supply </div>' + '  ' + '<div style="font-size: 15px; margin: 4px 0px; color: #fff">' + price.toFixed(2) + ' IND </div></div>';
             } else {
                 firstRow.innerHTML = '<div style="font-size: 24px; margin: 4px 0px; color: #fff"> Total Supply </div>' ;
             }
         });    